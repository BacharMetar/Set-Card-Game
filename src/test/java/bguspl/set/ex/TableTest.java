...
class TableTest {
    ...
    public void testRemoveCard()
    {
        ...
        int slot = 1;
        table.removeCard(1);
        assertEquals(null,slotToCard[1],"should be null");
    }

    //@inv table != null, not all slots are null
    //@pre player.number of token <3
    //@post player.number of token = @pre +1
    @Test
    public void testPlaceToken()
    {
        fillAllSlots();
        table.placeToken(0,2);
        assertEquals(table.tokenToplayer[0][2],true,"should be True");
